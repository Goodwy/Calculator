...
import dev.goodwy.math.databinding.ViewConverterBinding
import dev.goodwy.math.extensions.config
import dev.goodwy.math.helpers.BOTTOM_UNIT
import dev.goodwy.math.helpers.CONVERTER_VALUE
import dev.goodwy.math.helpers.NumberFormatHelper
import dev.goodwy.math.helpers.TOP_UNIT
...
class ConverterView @JvmOverloads constructor(
    ...
    private val formatter = NumberFormatHelper(context)
...
//        binding.topUnitHolder.background = rippleDrawable
        ...
        listOf(binding.topUnitSymbol, binding.bottomUnitSymbol).forEach {
            ...
            bgLayer.cornerRadius = context.resources.getDimension(
                com.goodwy.commons.R.dimen.rounded_corner_radius_big
            )
